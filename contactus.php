...
<ul>
	 ...
	 <li><a type="button" name="contactus"href="contactus.php"class="active">Contact us</a></li>
...
<p style="margin-left:25%;margin-top:5%">Email</p>
<p style="margin-left:27%">mahimk2307@gmail.com<img</p><img src="http://localhost/mail-logo.png"height="25" width="25"style="margin-left:1%;margin-top:2%"/><hr style="margin-left:25%">
<p style="margin-left:25%">Instagram</p>
<p style="margin-left:27%">m_a_h_e_s_h__mk_<img src="http://localhost/insta.png"height="25" width="33"style="margin-left:1%;margin-top:2%"/></p><hr style="margin-left:25%">
<p style="margin-left:25%">WhatsApp</p>
<p style="margin-left:27%">9994667518<img src="http://localhost/WhatsApp.png"height="25" width="25"style="margin-left:1%;margin-top:2%"/></p>
<div class="bottom">
